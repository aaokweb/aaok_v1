...
const map =
	'https://client-static-files-front-end.s3.us-east-2.amazonaws.com/media/AAOK_KumgangsanRegions_original.jpg';
const r1 =
	'https://client-static-files-front-end.s3.us-east-2.amazonaws.com/media/small-R1_Manpoktong_9327.jpg';
const r2 =
	'https://client-static-files-front-end.s3.us-east-2.amazonaws.com/media/small-R2_Ongnyudong_7342.jpg';
const r3 =
	'https://client-static-files-front-end.s3.us-east-2.amazonaws.com/media/small-R3_Podogam_0104.jpg';
const r4 =
	'https://client-static-files-front-end.s3.us-east-2.amazonaws.com/media/small-R4_NineDragonFalls_7875.jpg';
const r5 =
	'https://client-static-files-front-end.s3.us-east-2.amazonaws.com/media/small-R5_Samburam_1419.jpg';
const r6 =
	'https://client-static-files-front-end.s3.us-east-2.amazonaws.com/media/small-R6_Myogilsang_0904.jpg';
				...
				<Route exact path={routes.kumgangsan}>
						...
						>
							<p>
								<Lang
									...
									kr={
										<>
											아래에 제시된 여섯 곳의 사진 중 하나를 선택하여
											16세기 중반부터 20세기 초까지 한반도 중앙의
											금강산(金剛山)을 유람한 인물들에 의해 새겨진
											바위 글씨를 관람할 수 있다. 이러한 탐색 도구는
											제명 및 바위 글씨의 정확한 위치를 제시하여
											관람자의 공간적 이해를 도우며 현재 북한에
											속하여 대부분의 연구자가 접근하기 어려운
											금강산으로 가상 여행을 떠나는 흔치 않은 기회를
											제공한다.
										</>
									}
								/>
					...
					<p>
						{props.isEn ? (
							...
							<>
								<b style={{ color: 'orange' }}>지역을 선택하고</b>{' '}
								클릭하기
							</>
						)}
					</p>
