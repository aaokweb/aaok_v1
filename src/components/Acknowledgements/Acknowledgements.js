...
import profilePic from "../../media/Stiller_PortraitPicture.jpg";
  ...
  return (
    <LargePage>
      <h1 className="mobile-shrink">
        <Lang isEn={props.isEn} en="Acknowledgements" kr="아틀라스 팀 소개" />
      </h1>
      <hr />
      <Row>
        ...
        <Col xs={12} md={2} className="title">
          <h4><Lang isEn={props.isEn} en="Maya Stiller" kr="마야 스틸러" /></h4>
          <span><Lang isEn={props.isEn} en="AAOK Project Director" kr="AAOK 프로젝트 디렉터" /></span>
          <br />
        </Col>
        <Col xs={12} md={8}>
        <Lang
      ...
      <hr />
      <h2><Lang isEn={props.isEn} en="Contributors" kr="기여한 사람들" /></h2>

      <p>
        <h4 style={{ color: "orange" }}><Lang isEn={props.isEn} en="Spring 2022" kr="2022 년 봄" /></h4>
      </p>
      <hr />
      <Row className="round-bg pl-4">
        <Col md={4} className="additional-titles">
          ...
          <i>
            ...
            <Row><Lang
              isEn={props.isEn}
              en={constants_en.ak_eecs}
            ></Lang></Row>
            <Row><Lang
              isEn={props.isEn}
              en={constants_en.ak_ku}
            ></Lang></Row>
          </i>
        </Col>
        <Col md={8}>
      ...
      <p>
        <h4 style={{ color: "orange" }}><Lang isEn={props.isEn} en="Summer 2020 - Fall 2021" kr="2020년 여름 – 2021년 가을" /></h4>
      </p>
      <hr />
      <Row className="round-bg pl-4">
        <Col md={4} className="additional-titles">
      ...
      <hr />
      <p>
        <h4 style={{ color: "orange" }}><Lang isEn={props.isEn} en="Fall 2020" kr="2020 년 가을" /></h4>
      </p>
      <hr />
      <Row className="round-bg pl-4">
        <Col md={4} className="additional-titles">
      ...
      <Row className="round-bg pl-4">
        <Col md={4} className="additional-titles">
          ...
          <i>
            ...
            <Row><Lang
              isEn={props.isEn}
              en={constants_en.ak_cls}
            ></Lang></Row>
            <Row><Lang
              isEn={props.isEn}
              en={constants_en.ak_seoul}
            ></Lang></Row>
          </i>
        </Col>
        <Col md={8}>
      ...
      <hr />
      <p>
        <h4 style={{ color: "orange" }}><Lang isEn={props.isEn} en="Summer 2020" kr="2020 년 여름" /></h4>
      </p>
      <hr />
      <Row className="round-bg pl-4">
        <Col md={4} className="additional-titles">
      ...
      <hr />
      <p>
        <h4 style={{ color: "orange" }}><Lang isEn={props.isEn} en="Spring 2020" kr="2020 년 봄" /></h4>
      </p>
      <hr />
      <Row className="round-bg pl-4">
        <Col md={4} className="additional-titles">
      ...
      <hr />
      <p>
        <h4 style={{ color: "orange" }}><Lang isEn={props.isEn} en="Fall 2019 - Summer 2020" kr="2019 가을 – 2020 년 여름" /></h4>
      </p>
      <hr />
      <Row className="round-bg pl-4">
        <Col md={4} className="additional-titles">
      ...
      <hr />
      <p>
        <h4 style={{ color: "orange" }}><Lang isEn={props.isEn} en="Fall 2019" kr="2019 년 가을" /></h4>
      </p>
      <hr />
      <Row className="round-bg pl-4">
        <Col md={4} className="additional-titles">
      ...
      <hr />
      <p>
        <h4 style={{ color: "orange" }}><Lang isEn={props.isEn} en="Summer 2019" kr="2019 년 여름" /></h4>
      </p>
      <hr />
      <Row className="round-bg pl-4">
        <Col md={4} className="additional-titles">
      ...
      <hr />
      <p>
        <h4 style={{ color: "orange" }}><Lang isEn={props.isEn} en="Spring 2016" kr="2016 년 봄" /></h4>
      </p>
      <hr />
      <Row className="round-bg pl-4">
        <Col md={4} className="additional-titles">
