...
const imgNanhyang =
	'https://client-static-files-front-end.s3.us-east-2.amazonaws.com/media/featured1-smaller.jpg';
const imgChungin =
	'https://client-static-files-front-end.s3.us-east-2.amazonaws.com/media/featured2-smaller.jpg';

const img3 =
	'https://client-static-files-front-end.s3.us-east-2.amazonaws.com/media/featured3-smaller.jpg';
const img4 =
	'https://client-static-files-front-end.s3.us-east-2.amazonaws.com/media/featured4-smaller.jpg';
const img5 =
	'https://client-static-files-front-end.s3.us-east-2.amazonaws.com/media/featured5-smaller.jpg';
const img6 =
				...
				<Route exact path={routes.graffiti}>
					<p>
						<i>
							...
							of the featured graffiti below to learn about the
							individuals and circumstances behind it.
						</i>
					</p>
										...
										<Card.Text style={{ marginBottom: '8px' }}>
											<i>
												<Lang
													isEn={props.isEn}
													en={
														constants_en.graffitiNanhyang_cardCaption
													}
													kr={
														constants_kr.graffitiNanhyang_cardCaption
													}
												/>
											</i>
										</Card.Text>
										...
										<Card.Text style={{ marginBottom: '8px' }}>
											<i>
												<Lang
													isEn={props.isEn}
													en={
														constants_en.graffitichungin_cardCaption
													}
													kr={
														constants_kr.graffitichungin_cardCaption
													}
												/>
											</i>
										</Card.Text>
										...
										<Card.Text style={{ marginBottom: '8px' }}>
											<i>
												<Lang
													isEn={props.isEn}
													en={
														constants_en.graffitiYunsaguk_cardCaption
													}
													kr={
														constants_kr.graffitiYunsaguk_cardCaption
													}
												/>
											</i>
										</Card.Text>
										...
										<Card.Text style={{ marginBottom: '8px' }}>
											<i>
												<Lang
													isEn={props.isEn}
													en={
														constants_en.graffitiKyongsok_cardCaption
													}
													kr={
														constants_kr.graffitiKyongsok_cardCaption
													}
												/>
											</i>
										</Card.Text>
										...
										<Card.Text style={{ marginBottom: '8px' }}>
											<i>
												<Lang
													isEn={props.isEn}
													en={
														constants_en.graffitiKimhajong_cardCaption
													}
													kr={
														constants_kr.graffitiKimhajong_cardCaption
													}
												/>
											</i>
										</Card.Text>
										...
										<Card.Text style={{ marginBottom: '8px' }}>
											<i>
												<Lang
													isEn={props.isEn}
													en={
														constants_en.graffitiHonghyonju_cardCaption
													}
													kr={
														constants_kr.graffitiHonghyonju_cardCaption
													}
												/>
											</i>
										</Card.Text>
